...
export default function HCPDocumentsPreterm() {
  return (
    <div className="min-h-screen">
      ...
      {/* PDF: Egyptian preterm consensus */}
            ...
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              ...
              <div style={{width: '100%', marginTop: '2rem'}}>
                <div style={{marginBottom: '1rem', textAlign: 'center'}}>
                  <a
                    href="/Egyptian-preterm-consensus.pdf"
                    target="_blank"
                ...
                <object
                  data="/Egyptian-preterm-consensus.pdf#toolbar=1"
                  type="application/pdf"
                  width="100%"
                  height="800px"
                  style={{border: 'none', borderRadius: '8px', display: 'block'}}
                  aria-label="Egyptian preterm consensus PDF"
                >
                  <iframe
                  ...
                  <p style={{textAlign: 'center', padding: '2rem', color: '#666'}}>
                    ...
                    <a href="/Egyptian-preterm-consensus.pdf" target="_blank" rel="noopener noreferrer" style={{color: '#40606D', fontWeight: 600}}>Open or download the PDF</a>.
                  </p>
                </object>
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/Egyptian-preterm-consensus.pdf"
                    download="Egyptian-preterm-consensus.pdf"
                    style={{
                      display: 'inline-block',
                      padding: '0.75rem 2rem',
                      background: '#40606D',
