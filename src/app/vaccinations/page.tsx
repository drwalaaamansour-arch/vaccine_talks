...
import { PUBLIC_VACCINATIONS } from '@/data/public-vaccinations-hub';
...
export default function VaccinationsPage() {
  ...
  return (
    <div className="min-h-screen vax-hub-page" dir="rtl">
      <Header />
      ...
      <section className="about-section">
        <div className="about-elegant-card vax-hub-elegant">
          ...
          <div className="vax-hub-inner">
            <header className="vax-hub-hero">
              <div className="vax-hub-hero-glow" aria-hidden />
              <span className="vax-hub-hero-tag">دليل التطعيمات في مصر · Your vaccine guide</span>
              <h2 className="vax-hub-hero-title">التطعيمات المتاحة</h2>
              <p className="vax-hub-hero-subtitle hub-en" lang="en">
                Available Vaccinations
              </p>
              <p className="vax-hub-hero-lead">
                اختاروا التطعيم اللي عاوزين تعرفوا عنه — معلومات واضحة بالعربي والإنجليزي لكل لقاح في مصر.
              </p>
              <div className="hub-hero-meta">
                <ArticleMetaDate {...ARTICLE_META.vaccinations} locale="ar" align="center" compact />
              </div>
            </header>
            ...
            <div className="vax-hub-search-wrap">
              ...
              />
              {query && (
                <button type="button" className="vax-hub-search-clear" onClick={() => setQuery('')} aria-label="Clear search">
                  ✕
                </button>
              )}
            </div>
            ...
            <div className="vax-hub-grid">
              {filteredVaccines.map((vax) => (
                <Link key={vax.href} href={vax.href} className="vax-hub-tile">
                  ...
                  <span className="vax-hub-tile-ar">{vax.ar}</span>
