...
export default function Home() {
  return (
    <div className="min-h-screen home-page">
      ...
      <section
        className="about-section home-section home-audience-section"
      ...
      >
        <div className="about-elegant-card">
          ...
          <header className="home-audience-header">
            <h2 id="home-paths-heading" className="home-audience-title">
              <span className="home-audience-title-en">Choose your path</span>
              <span className="home-audience-title-sep" aria-hidden>
                {' '}
                /{' '}
              </span>
              <span className="home-audience-title-ar" lang="ar">
                اختر مسارك
              </span>
            </h2>
          </header>

          <div className="about-bilingual home-audience-bilingual">
            <div className="about-lang arabic">
              ...
              <a href="/non-hcp" className="start-button">
                Non-HCP (غير العاملين بالمجال الطبي)
              </a>
            </div>
            ...
            <div className="about-lang">
              ...
              <a href="/hcp-resources" className="start-button">
                HCP Resources (العاملين بالمجال الطبي)
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="about-elegant-card">
          ...
          <div className="about-bilingual">
            <div className="about-lang home-full-width-lang">
              <h2 className="about-lang-title home-section-heading home-section-heading--spotlight">
