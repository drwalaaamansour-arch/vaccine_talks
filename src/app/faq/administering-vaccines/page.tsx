  ...
  return (
    <div className="min-h-screen">
      ...
      <section style={{padding:'0.5rem 1rem 0'}}>
        <ArticlePageTitle {...ARTICLE_META.faqAdministeringVaccines} titleStyle={{textAlign:'center', fontSize:'2rem', margin:'0'}} locale="en">FAQ – Administering Vaccines</ArticlePageTitle>
      </section>
