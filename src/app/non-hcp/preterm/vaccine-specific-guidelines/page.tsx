...
export default function NonHcpPretermVaccineSpecificGuidelinesPage() {
  return (
        ...
        <div className="about-elegant-card">
          ...
          <div className="coming-soon-container" style={{ width: '100%' }}>
            <div className="coming-soon-content" style={{ width: '100%', maxWidth: '100%' }}>
              ...
              >
                Vaccine-Specific Guidelines for Preterm Infants
              </p>
              <PretermVaccineGuidelinesTabs />
              ...
              <hr
                style={{
                  ...
                  maxWidth: '720px',
                  border: 'none',
                  borderTop: '2px solid rgba(64, 96, 109, 0.2)',
                }}
              />
              <PretermVaccineGuidelinesTabsEnglish />
            </div>
          </div>
        </div>
      </section>
