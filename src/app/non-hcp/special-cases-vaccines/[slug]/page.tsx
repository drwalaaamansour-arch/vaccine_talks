...
const specialCasesMap: Record<string, { ar: string; en: string }> = {
  'preterm-infants': {
    ar: 'تطعيمات الأطفال المبتسرين',
  ...
  splenectomy: {
    ar: 'تطعيمات استئصال الطحال',
    en: 'Vaccinations After Splenectomy',
  },
  'during-and-after-chemotherapy': {
    ar: 'تطعيمات اثناء وبعد الكيماوي',
    en: 'Vaccinations During and After Chemotherapy',
  },
  'post-bone-marrow-transplant': {
    ar: 'تطعيمات بعد عمليات زرع النخاع',
    en: 'Vaccinations After Bone Marrow Transplant',
  },
...
export default async function SpecialCaseComingSoonPage({
  ...
  const section = specialCasesMap[slug];
        ...
        <div className="about-elegant-card">
          ...
          <div className="coming-soon-container">
            <div className="coming-soon-content">
              <h2 className="about-lang-title" style={{ textAlign: 'center', fontSize: '2.25rem', marginBottom: '0.75rem', color: '#40606D', direction: 'rtl' }}>
                {section.ar}
              </h2>
              <h3 className="about-lang-title" style={{ textAlign: 'center', fontSize: '1.3rem', marginBottom: '1rem', color: '#6B8A96' }}>
                {section.en}
              </h3>
