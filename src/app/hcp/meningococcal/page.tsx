    ...
    <div className="min-h-screen">
        ...
        <div className="about-elegant-card">
          ...
          <div className="about-bilingual">
            <div className="about-lang" style={{alignItems: 'flex-start'}}>
              <VaccineLangTitle {...ARTICLE_META.hcpMeningococcal} style={{textAlign: 'center', fontSize: '2.5rem', alignSelf: 'center'}} locale="en">
                Meningococcal
              </VaccineLangTitle>
      ...
      <section className="about-section">
        <div className="about-elegant-card">
          ...
          <div className="about-bilingual">
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              <h2 className="about-lang-title" style={{textAlign: 'center', fontSize: '2.5rem', alignSelf: 'center'}}>AC – Product Information</h2>
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe src="/Ac.pdf" width="100%" height="800px" style={{border: 'none', borderRadius: '8px'}} title="AC PDF" />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a href="/Ac.pdf" download style={{display: 'inline-block', padding: '0.75rem 2rem', background: '#40606D', color: 'white', textDecoration: 'none', borderRadius: '6px', fontWeight: '600', transition: 'all 0.3s ease'}}>Download PDF / تحميل PDF</a>
                </div>
                <p style={{marginTop: '1rem', textAlign: 'center', direction: 'rtl', color: '#40606D', lineHeight: 1.6}}>
                  المصدر: الهيئة المصرية للدواء / وزارة الصحة<br />
                  لا توجد علاقة مباشرة بين الموقع وهذه الشركات، والمحتوى لأغراض التوعية فقط. ولا يجوز استخدامها في أي أغراض تجارية
      ...
      <section className="about-section">
        <div className="about-elegant-card">
          ...
          <div className="about-bilingual">
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              <h2 className="about-lang-title" style={{textAlign: 'center', fontSize: '2.5rem', alignSelf: 'center'}}>MenQuadfi FDA Insert</h2>
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe src="/menquadfi%20FDA%20insert.pdf" width="100%" height="800px" style={{border: 'none', borderRadius: '8px'}} title="MenQuadfi FDA Insert PDF" />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a href="/menquadfi%20FDA%20insert.pdf" download style={{display: 'inline-block', padding: '0.75rem 2rem', background: '#40606D', color: 'white', textDecoration: 'none', borderRadius: '6px', fontWeight: '600', transition: 'all 0.3s ease'}}>Download PDF / تحميل PDF</a>
                </div>
                <p style={{marginTop: '1rem', textAlign: 'center', direction: 'rtl', color: '#40606D', lineHeight: 1.6}}>
                  المصدر: الهيئة المصرية للدواء / وزارة الصحة<br />
                  لا توجد علاقة مباشرة بين الموقع وهذه الشركات، والمحتوى لأغراض التوعية فقط. ولا يجوز استخدامها في أي أغراض تجارية
