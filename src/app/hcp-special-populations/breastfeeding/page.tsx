        ...
        <div className="about-elegant-card">
          ...
          <div className="about-bilingual">
            <div className="about-lang hcp-content-column">
              <p style={{ margin: '0 0 1.25rem', textAlign: 'left' }}>
                <Link
              ...
              <ArticlePageTitle {...ARTICLE_META.hcpBreastfeeding} locale="en">
              ...
              >
                <ContentChunk title="General principles" accent="sage">
                  <p style={p()}>
                    With 2 exceptions, neither non-live nor live-virus vaccines administered to a
                    lactating woman affect the safety of breastfeeding for women or their infants.
                    Although live viruses in vaccines can replicate in the mother, the majority of
                    live viruses in vaccines have been demonstrated not to be excreted in human milk.
                  </p>
                  <p style={p()}>
                    Varicella vaccine virus has not been found in human milk. Although rubella vaccine
                    virus has been excreted in human milk, the virus usually does not infect the
                    infant. If infection does occur, it is well tolerated because the virus is
                    attenuated.
                  </p>
                  <p style={{ marginBottom: 0 }}>
                    Non-live vaccines pose no risk for mothers who are breastfeeding or for their
                    infants.
                  </p>
                </ContentChunk>

                <ContentChunk title="Smallpox vaccination" accent="slate">
                  <p style={{ marginBottom: 0 }}>
                    Breastfeeding is a contraindication for smallpox vaccination of the mother because
                    of the theoretical risk for contact transmission from mother to infant.
                  </p>
                </ContentChunk>

                <ContentChunk title="Yellow fever vaccine" accent="sage">
                  <p style={p()}>
                    Yellow fever vaccine should be avoided in breastfeeding women, because 2 cases (one
                    confirmed, one probable) of yellow-fever vaccine associated acute neurotropic disease
                    (YEL-AND) have been detected in infants whose mothers were vaccinated but were not
                    vaccinated themselves. In both infants, vaccine virus was recovered from the
                    cerebrospinal fluid of the infant, but the exact mode of transmission was not
                    precisely determined because vaccine virus was not recovered from breast milk.
                  </p>
                  <p style={{ marginBottom: 0 }}>
                ...
                <ContentChunk title="Infant vaccination" accent="slate">
                  <p style={p()}>
                    Limited data indicate that breastfeeding can enhance the response to certain
                    vaccine antigens. There are no data to suggest that passive transfer of antibodies in
                    human milk can affect the efficacy of live-virus vaccines.
                  </p>
                  <p style={{ marginBottom: 0 }}>
              ...
              >
                ...
                >
                  <li style={{ marginBottom: 0 }}>
                    <a
                      href="https://www.cdc.gov/vaccines/hcp/imz-best-practices/special-situations.html#cdc_report_pub_study_section_5-breastfeeding-and-vaccination"
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{ color: '#40606D', textDecoration: 'underline', textUnderlineOffset: '3px' }}
                    >
                      CDC: Best practices — Breastfeeding and vaccination
                    </a>
                  </li>
                </ul>
              </aside>
