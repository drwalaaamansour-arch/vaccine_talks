        ...
        <div className="about-elegant-card">
          <div className="about-bilingual">
            <div className="about-lang" style={{alignItems: 'flex-start'}}>
              ...
              <p className="about-lang-intro" style={{direction: 'ltr', textAlign: 'left'}}>
                Children 12 through 59 months who are at high risk for invasive Hib disease (i.e., recipients of <strong>chemotherapy</strong> or <strong>radiation</strong> for malignant neoplasms, or those with functional or anatomic <strong>asplenia</strong>, <strong>HIV</strong> infection, <strong>immunoglobulin deficiency, or early complement component deficiency</strong>) and who are unvaccinated or received only one dose of Hib vaccine before 12 months of age should receive 2 additional doses of Hib vaccine; those who received 2 or more doses of Hib before 12 months of age should receive one additional dose.
              </p>
              <p className="about-lang-intro" style={{direction: 'ltr', textAlign: 'left'}}>
                A child younger than 5 years of age receiving <strong>chemotherapy</strong> or <strong>radiation</strong> therapy should have Hib doses repeated if the doses were received during therapy or within 14 days of starting therapy; repeat doses should be started at least 3 months after completion of therapy.
              </p>
              <p className="about-lang-intro" style={{direction: 'ltr', textAlign: 'left'}}>
                Recipients of <strong>hematopoietic cell transplants</strong> should be revaccinated with 3 doses of Hib vaccine, starting 6-12 months after successful transplant, regardless of vaccination history or age.
              </p>
              <p className="about-lang-intro" style={{direction: 'ltr', textAlign: 'left'}}>
                Children 5-18 years of age with <strong>HIV</strong> who are unimmunized should receive a dose of Hib vaccine; Hib vaccination is not recommended in <strong>HIV</strong>-infected adults.
              </p>
              <p className="about-lang-intro" style={{direction: 'ltr', textAlign: 'left'}}>
                Unimmunized asplenic patients older than 59 months of age or adults should receive a dose of Hib vaccine. Anyone 15 months of age or older who is undergoing a splenectomy and is unimmunized should receive a dose of Hib vaccine.
              </p>
              <p className="about-lang-intro" style={{direction: 'ltr', textAlign: 'left', marginBottom: '0.5rem', fontSize: '1.2rem', fontWeight: 700}}>
                To learn more about disease, vaccine and inserts <a href="http://127.0.0.1:3000/hcp/hib" style={{textDecoration: 'underline', color: '#40606D'}}>press here</a>.
              </p>
