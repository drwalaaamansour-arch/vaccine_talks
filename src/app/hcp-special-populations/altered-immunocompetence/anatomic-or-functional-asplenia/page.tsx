...
export default function AnatomicOrFunctionalAspleniaPage() {
  return (
        ...
        <div className="about-elegant-card">
          <div className="about-bilingual">
            <div className="about-lang" style={{alignItems: 'flex-start'}}>
              <ArticlePageTitle {...ARTICLE_META.hcpAsplenia} titleStyle={{ fontSize: '2rem' }} locale="en">
              ...
              <h3 style={{textAlign: 'left', fontSize: '1.35rem', fontWeight: 700, color: '#40606D', marginTop: '2rem', marginBottom: '1rem', width: '100%', direction: 'ltr'}}>
                The recommended vaccines:
              </h3>
              <div style={{display: 'flex', flexWrap: 'wrap', gap: '0.75rem', width: '100%', justifyContent: 'flex-start'}}>
                <a
                  href="/hcp-special-populations/altered-immunocompetence/anatomic-or-functional-asplenia/pneumococcal"
                  style={{flex: '1 1 200px', textAlign: 'center', padding: '0.9rem 1.25rem', background: '#40606D', color: 'white', textDecoration: 'none', borderRadius: '10px', fontWeight: 700, fontSize: '1rem', boxShadow: '0 4px 12px rgba(0,0,0,0.08)'}}
                >
                  Pneumococcal
                </a>
                <a
              ...
              <p className="about-lang-intro" style={{direction: 'ltr', textAlign: 'left', marginTop: '1.25rem', fontStyle: 'italic'}}>
              ...
              <ul style={{direction: 'ltr', textAlign: 'left', width: '100%', margin: 0, paddingLeft: '1.35rem', color: '#374151', fontSize: '1rem', lineHeight: 1.6}}>
                <li style={{marginBottom: '0.5rem'}}>
                  ...
                  >
                    Australian Immunisation Handbook: People with asplenia and hyposplenia
                  </a>
                </li>
                <li>
                  <a
