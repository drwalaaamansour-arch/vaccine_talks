...
import type { AnaesthesiaCopy, AnaesthesiaParagraph } from '@/data/anaesthesia-surgery-copy';

function renderParagraph(paragraph: AnaesthesiaParagraph, key: string) {
...
export function AnaesthesiaSurgeryBody({ copy, arabic }: { copy: AnaesthesiaCopy; arabic?: boolean }) {
