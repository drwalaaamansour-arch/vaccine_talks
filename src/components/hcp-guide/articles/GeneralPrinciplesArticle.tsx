...
const TOC = [
  ...
  { id: 'vaccine-safety-effectiveness', label: 'Safety & effectiveness' },
] as const;
...
export default function GeneralPrinciplesArticle() {
  return (
    <HcpGuidePageLayout
      ...
      emoji="📖"
      lead="Altered immunocompetence — primary and secondary causes, and vaccine safety and effectiveness in immunocompromised patients."
    ...
    >
      <div className="hcp-guide-hsct" style={{ display: 'flex', flexDirection: 'column', gap: '1.35rem', width: '100%' }}>
        ...
        <div id="vaccine-safety-effectiveness">
              <h3
