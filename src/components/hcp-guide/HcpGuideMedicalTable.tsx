...
export default function HcpGuideMedicalTable({ caption, columns, rows }: HcpGuideMedicalTableProps) {
  return (
    <div className="hcp-guide-table-wrap">
      <table className="hcp-guide-table">
        <caption className="hcp-guide-table-caption">{caption}</caption>
        <thead>
          <tr>
            {columns.map((column) => (
