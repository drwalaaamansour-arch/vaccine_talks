...
export const FAQ_VARICELLA_PAGE: FaqPageConfig = {
  "metaKey": "faqVaricella",
  "topic": {
    "tag": "HCP · Clinical FAQ · Egypt",
    "title": "Varicella",
    "subtitle": "FAQ",
    "emoji": "🔴",
    "lead": "Varicella vaccine schedules and post-exposure use.",
    "backHref": "/hcp-faq",
  ...
  "items": [
    {
      "id": "q-1",
      "question": "How is varicella transmitted and for how long is an infected person contagious?",
      "paragraphs": [
    ...
    {
      "id": "q-2",
      "question": "What do you give to a child younger than 1 year of age if they were exposed to the chickenpox or zoster virus?",
      "paragraphs": [
    ...
    {
      "id": "q-3",
      "question": "Does ACIP recommend giving varicella vaccine to infants before age 1 year if they are traveling internationally?",
      "paragraphs": [
    ...
    {
      "id": "q-4",
      "question": "Can varicella vaccine be used as postexposure prophylaxis for a 9-month-old who was exposed to herpes zoster?",
      "paragraphs": [
    ...
    {
      "id": "q-5",
      "question": "I have a patient who is 52 years old and is immigrating to the U.S. She received a dose of recombinant zoster vaccine (Shingrix) at age 50. The immigration requirements state she should receive 2 doses of varicella vaccine. Does she need additional varicella vaccine?",
      "paragraphs": [
    ...
    {
      "id": "q-6",
      "question": "Concerning the recommendation for a second dose of varicella vaccine, does CDC recommend that a teen who received only one varicella vaccine when they were preschool age get a second dose now?",
      "paragraphs": [
    ...
    {
      "id": "q-7",
      "question": "Originally, ACIP only recommended one dose of varicella vaccine for children. Why did ACIP later revise its recommendations to add a second dose of varicella vaccine for all children?",
      "paragraphs": [
    ...
    {
      "id": "q-8",
      "question": "Should a child who has had chickenpox prior to the first birthday get the first dose of varicella vaccine at age 1 year?",
      "paragraphs": [
    ...
    {
      "id": "q-9",
      "question": "If an adult or child has not had documented chickenpox but has had shingles, is varicella vaccination recommended?",
      "paragraphs": [
    ...
    {
      "id": "q-12",
      "question": "I understand that varicella vaccine can be used in postexposure settings. How soon after exposure does the vaccine need to be administered?",
      "paragraphs": [
    ...
    {
      "id": "q-13",
      "question": "A healthcare worker with no history of chickenpox, and unknown serologic immunity, was exposed to a patient with zoster. She received varicella vaccine two days later. She developed a pruritic maculopapular rash 11 days after vaccination. Is the rash from the vaccine or from her zoster exposure?",
      "paragraphs": [
    ...
    {
      "id": "q-14",
      "question": "Does varicella vaccine affect tuberculosis skin test readings in the same way that MMR does?",
      "paragraphs": [
    ...
    {
      "id": "q-15",
      "question": "What are the recommendations for varicella vaccination before and after pregnancy?",
      "paragraphs": [
    ...
    {
      "id": "q-16",
      "question": "How long should a person who has had varicella vaccination wait before becoming pregnant?",
      "paragraphs": [
    ...
    {
      "id": "q-17",
      "question": "If a person receives varicella vaccine and subsequently confirms pregnancy, what should the person be told about the risk to the fetus?",
      "paragraphs": [
    ...
    {
      "id": "q-18",
      "question": "What is the recommended schedule for vaccinating a child? What about adults?",
      "paragraphs": [
    ...
    {
      "id": "q-19",
      "question": "A child received only one dose of varicella vaccine and subsequently tests positive for varicella IgG antibody. Does the child still need a second dose of varicella vaccine?",
      "paragraphs": [
        "Varicella postvaccination serologic testing is not recommended; however, if a person tests positive for varicella antibody 28 days or more after vaccination, the Advisory Committee on Immunization Practices (ACIP) considers the person to be immune. Studies have shown that a second dose boosts antibody titers and indicators of cell-mediated immunity significantly above the levels produced by a single dose. A second dose may be required to comply with school entry or institutional immunization requirements, regardless of serologic test results."
      ]
    },
    {
      "id": "q-20",
      "question": "A nursing student received 2 valid, documented doses of varicella vaccine. For whatever reason, she subsequently had a titer drawn. The titer was negative. Do you recommend revaccination with 2 doses of varicella vaccine?",
      "paragraphs": [
        "No. Documented receipt of 2 doses of varicella vaccine supersedes results of subsequent serologic testing. Most commercially available tests for varicella antibody are not sensitive enough to detect vaccine-induced antibody, which is why CDC does not recommend post-vaccination testing"
      ]
    },
    {
      "id": "q-21",
      "question": "What are the contraindications and precautions to varicella vaccine?",
      "paragraphs": [
        "**Contraindications:**",
    ...
    {
      "id": "q-22",
      "question": "What are the recommendations for the use of varicella vaccine in children with HIV or other immunodeficiencies?",
      "paragraphs": [
    ...
    {
      "id": "q-23",
      "question": "Recently we had a one-year-old with congenital heart disease and who is on chronic aspirin therapy in for a well-child check and routine vaccination. Are there any recommendations regarding varicella vaccine being given to children who are on chronic aspirin therapy?",
      "paragraphs": [
    ...
    {
      "id": "q-24",
      "question": "After receiving varicella vaccine, should healthcare personnel avoid contact with immunocompromised patients?",
      "paragraphs": [
    ...
    {
      "id": "q-25",
      "question": "If a patient is breast-feeding her six-month-old baby, can she receive varicella vaccine without the risk of transmitting the vaccine virus to her baby?",
      "paragraphs": [
    ...
    {
      "id": "q-26",
      "question": "A 10-year-old girl came to our immunization clinic, and the nurse noted crusted lesions on her arms and legs. The parent said the child had had chickenpox a week earlier. The girl was not ill, so we vaccinated her. But now I wonder if her recent case of chickenpox might interfere with her immune response to vaccines.",
      "paragraphs": [
        "A previous history of chickenpox disease, even recent disease, is not known to interfere with the immune response to different vaccines. To review the true contraindications and precautions to vaccination,"
      ]
    },
    {
      "id": "q-27",
      "question": "We have a patient who has selective IgA deficiency. We also have patients with selective IgM deficiency. Can MMR or varicella vaccine be administered to these patients?",
      "paragraphs": [
    ...
    {
      "id": "q-28",
      "question": "If a child had 1 varicella vaccination and developed a vesicular (chickenpox-like) rash at the vaccination site 7 to 10 days after vaccination, does the patient still need the second dose? What if the rash covered the entire body?",
      "paragraphs": [
    ...
    {
      "id": "q-29",
      "question": "If a child breaks out in 5 to 10 maculopapular spots 2 weeks following varicella vaccination, can s/he go to school?",
      "paragraphs": [
    ...
    {
      "id": "q-30",
      "question": "If a vaccinated child gets 5 to 10 vesicular lesions 2 weeks after vaccination, can s/he attend school?",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        ...
        "As a general rule, whenever feasible, it is recommended that non-live and live vaccines be administered 2 or more weeks before initiating immunosuppressive medications include human immune mediators like interleukins and colony-stimulating factors, immune modulators, and medicines like tumor necrosis factor-alpha inhibitors and anti-B cell agents."
      ]
    },
    {
      "id": "q-32",
      "question": "An 8-month-old was erroneously given varicella vaccine. What might the consequences be? What should we do now?",
      "paragraphs": [
