...
export const FAQ_MENINGOCOCCAL_B_PAGE: FaqPageConfig = {
  "metaKey": "faqMeningococcalB",
  "topic": {
    "tag": "HCP · Clinical FAQ · Egypt",
    "title": "Meningococcal (B)",
    "subtitle": "FAQ",
    "emoji": "🧬",
    "lead": "MenB vaccination for infants, adolescents, and increased-risk groups.",
    "backHref": "/hcp-faq",
  ...
  "items": [
    {
      "id": "q-1",
      "question": "Please tell us about meningococcal disease.",
      "paragraphs": [
    ...
    {
      "id": "q-2",
      "question": "What groups are at increased risk for meningococcal disease?",
      "paragraphs": [
    ...
    {
      "id": "q-3",
      "question": "What meningococcal vaccines are available in the United States?",
      "paragraphs": [
    ...
    {
      "id": "q-4",
      "question": "Who is recommended to be vaccinated against meningococcal B disease?",
      "paragraphs": [
    ...
    {
      "id": "q-5",
      "question": "The ACIP recommendations for meningococcal serogroup B (MenB) vaccine say the vaccine will provide \"short term protection.\" What does \"short term protection\" mean?",
      "paragraphs": [
    ...
    {
      "id": "q-6",
      "question": "What is the schedule for MenB?",
      "paragraphs": [
    ...
    {
      "id": "q-7",
      "question": "Why did FDA change the dosing schedule for Bexsero (GSK) in August 2024, and do I need to recall my patients who received Bexsero under the old schedule?",
      "paragraphs": [
    ...
    {
      "id": "q-8",
      "question": "My patient with functional asplenia due to sickle cell disease inadvertently received MenB dose 3 too early, only 4 months after dose 1 and 3 months after dose 2. What do I do?",
      "paragraphs": [
    ...
    {
      "id": "q-9",
      "question": "Which patients should receive a 2-dose schedule of MenB vaccine?",
      "paragraphs": [
    ...
    {
      "id": "q-10",
      "question": "If a patient received Trumenba meningococcal B vaccine (MenB-FHbp) 2 months ago and Bexsero meningococcal B vaccine (MenB-4C) yesterday, should they complete the series with Trumenba or with Bexsero since the two brands are not interchangeable?",
      "paragraphs": [
    ...
    {
      "id": "q-11",
      "question": "Do any of the bacterial vaccines that are recommended for people with functional or anatomic asplenia need to be given before splenectomy? Do the doses count if they are given during the 2 weeks prior to surgery?",
      "paragraphs": [
    ...
    {
      "id": "q-12",
      "question": "My 36-year-old patient was diagnosed with idiopathic thrombocytopenic purpura and had a splenectomy three weeks ago. Prior to the splenectomy, he had one dose each of Hib, MenB, PCV20, and MenACWY (Menveo). What vaccines are recommended now?",
      "paragraphs": [
    ...
    {
      "id": "q-14",
      "question": "I have a patient with paroxysmal nocturnal hemoglobinuria who is being treated with Soliris (eculizumab). Should he receive meningococcal vaccine?",
      "paragraphs": [
    ...
    {
      "id": "q-15",
      "question": "We have a 10-year-old getting renal dialysis. The nephrologist will be starting her on ravulizumab (Ultomiris), which interferes with C5 complement. If we administer MenACWY and pneumococcal conjugate vaccine (PCV) now, will the MenACWY interfere with the PCV?",
      "paragraphs": [
    ...
    {
      "id": "q-16",
      "question": "If you choose to give MenB vaccine to a 16-year-old with HIV infection based on shared clinical decision-making, should you use the 2-dose (standard) schedule or the 3-dose (high-risk) schedule?",
      "paragraphs": [
    ...
    {
      "id": "q-17",
      "question": "Are microbiologists recommended to receive MenB vaccine? And if so, how frequently?",
      "paragraphs": [
    ...
    {
      "id": "q-19",
      "question": "Which groups should receive a booster dose of meningococcal B vaccine (MenB)?",
      "paragraphs": [
    ...
    {
      "id": "q-21",
      "question": "What adverse events are expected after receiving MenB?",
      "paragraphs": [
    ...
    {
      "id": "q-22",
      "question": "What are the contraindications and precautions for MenB vaccination?",
      "paragraphs": [
    ...
    {
      "id": "q-23",
      "question": "Should a pregnant person receive MenB vaccine?",
      "paragraphs": [
    ...
    {
      "id": "q-24",
      "question": "Can MenACWY and MenB vaccines be given at the same visit?",
      "paragraphs": [
    ...
    {
      "id": "q-25",
      "question": "By what route should meningococcal vaccines be administered?",
      "paragraphs": [
